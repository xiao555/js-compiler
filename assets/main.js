...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(document).ready(function ($) {
	  ...
	  // Init CodeMirror
	  var editor = _codemirror2.default.fromTextArea(document.getElementById("codearea"), {
	    lineNumbers: true,
	    mode: "javascript",
	    matchBrackets: true
	  });
...
/***/ function(module, exports) {
	...
	var TokenTable = [['CONST_ID', "PI", 3], ['CONST_ID', "E", 2], ['T', "T", 0.0], ['FUNC', "SIN", 0.0], ['FUNC', "COS", 0.0], ['FUNC', "TAN", 0.0], ['FUNC', "LOG", 0.0], ['FUNC', "EXP", 0.0], ['FUNC', "SQRT", 0.0], ['ORIGIN', "ORIGIN", 0.0], ['SCALE', "SCALE", 0.0], ['ROT', "ROT", 0.0], ['IS', "IS", 0.0], ['FOR', "FOR", 0.0], ['FROM', "FROM", 0.0], ['TO', "TO", 0.0], ['STEP', "STEP", 0.0], ['DRAW', "DRAW", 0.0]];
	// Recording data
	var origin_x, origin_y, rot, scale_x, scale_y;
	...
	*/
	function parser(tokens) {
	  ...
	  function walk() {
	    ...
	    if (token.type === 'ORIGIN' || token.type === 'SCALE' || token.type === 'ROT') {
	...
	function codeGenerator(node) {
	  ...
	  switch (node.type) {
	    ...
	    case 'Expression':
	      return '(Math.' + node.name.toLowerCase() + "(" + node.params + "))";
	    default:
